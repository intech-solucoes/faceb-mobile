...
interface State {
  ...
  dadosSimulacao: {
    ...
    fatorAtuarialPensaoMorte: number;
    fatorAtuarialSemPensaoMorte: number;
    rendaPrazoIndeterminadoPensaoMorte: number;
    rendaPrazoIndeterminadoSemPensaoMorte: number;
    listaPrazos: Array<any>;
    listaSaldoPercentuais: Array<any>;
  }
}

export class SimuladorNaoParticipantesResultadoScreen extends Component<Props, State> {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      dadosSimulacao: {
        ...
        email: "",
        valorFuturo: 0,
        dataAposentadoria: new Date(),
        valorSaque: 0,
        idadeDependente: 0,
        fatorAtuarialPensaoMorte: 0,
        fatorAtuarialSemPensaoMorte: 0,
        rendaPrazoIndeterminadoPensaoMorte: 0,
        rendaPrazoIndeterminadoSemPensaoMorte: 0,
        listaPrazos: new Array<any>(),
        listaSaldoPercentuais: new Array<any>()
      }
    }
  }
      ...
      <ScrollView style={Styles.scrollContainer} contentContainerStyle={Styles.scrollContainerContent}>
        ...
        <View>
          ...
          <View style={{ padding: 10 }}>
            ...
            <CampoEstatico titulo={"Data da Aposentadoria:"} valor={moment(this.state.dadosSimulacao.dataAposentadoria, "DD/MM/YYYY").format("DD/MM/YYYY")} />
          ...
          <View style={{ padding: 10, marginBottom: 10 }}>
            ...
            <View style={{ marginBottom: 15 }}>
              ...
              <TextMask style={[Styles.h2, { color: Variables.colors.primary }]} type={'money'} value={this.state.dadosSimulacao.rendaPrazoIndeterminadoPensaoMorte.toString()} />
            </View>
            ...
            <View style={{ marginBottom: 0 }}>
              ...
              <TextMask style={[Styles.h2, { color: Variables.colors.primary }]} type={'money'} value={this.state.dadosSimulacao.rendaPrazoIndeterminadoSemPensaoMorte.toString()} />
            </View>
